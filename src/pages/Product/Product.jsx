...
const Product = () => {
    ...
    return (
        <section className=' px-10 py-10 flex flex-col items-center w-screen h-screen'>
            <div className=' flex gap-10 h-full w-screen px-20 '>

                <div className='w-2/6 h-5/6 min-h-52 md:min-w-32  rounded-3xl p-3 bg-cover bg-no-repeat' style={{ backgroundImage: `url(${product.image})` }}>
